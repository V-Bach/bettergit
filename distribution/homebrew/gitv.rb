class Gitv < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm?
      url "https://github.com/V-Bach/bettergit/releases/download/v0.9.0-rc2/gitv-darwin-arm64.tar.gz"
      sha256 "26aab502ad2cec8fb1822fc33332acf0867100f225280eb80fcef85dbb45d4e1"
    else
      odie "Intel Macs are not supported in this release."
    end
  elsif OS.linux?
    url "https://github.com/V-Bach/bettergit/releases/download/v0.9.0-rc2/gitv-linux-amd64.tar.gz"
